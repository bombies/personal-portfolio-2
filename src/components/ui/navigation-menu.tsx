...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-neutral-darker px-4 py-2 text-sm font-medium transition-colors hover:bg-primary/10 hover:text-neutral-100 focus:bg-neutral-900 focus:text-neutral-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-neutral-900/50 data-[state=open]:bg-neutral-900/50"
)
